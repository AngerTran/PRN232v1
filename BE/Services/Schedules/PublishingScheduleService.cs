...
namespace PRN232v1.Services.Schedules;
...
public class PublishingScheduleService
{
    ...
    private async Task<SeriesEntity> RequireSeriesAccessAsync(
        Guid callerId,
        Guid seriesId,
        CancellationToken cancellationToken)
    {
        ...
        var series = await _unitOfWork.Repository<SeriesEntity>().GetByIdAsync(seriesId, cancellationToken: cancellationToken)
