...
namespace PRN232v1.Services.Rankings;
...
public class RankingService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var seriesExists = await _unitOfWork.Repository<Models.Series>()
        ...
        var series = await _unitOfWork.Repository<Models.Series>()
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var series = await _unitOfWork.Repository<Models.Series>().GetByIdAsync(seriesId, cancellationToken: cancellationToken);
        if (series is null)
        {
            return null;
        }
    ...
    private static bool CanViewRankingHistory(Profile caller, Models.Series series) =>
