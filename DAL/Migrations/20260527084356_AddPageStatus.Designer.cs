...
namespace DAL.Migrations
{
    ...
    [Migration("20260527084356_AddPageStatus")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PRN232v1.Models.ActivityLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PRN232v1.Models.AiSegmentationResult", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PRN232v1.Models.Annotation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PRN232v1.Models.BoardVote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PRN232v1.Models.Chapter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PRN232v1.Models.EditorTask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PRN232v1.Models.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PRN232v1.Models.Page", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PRN232v1.Models.Profile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("PRN232v1.Models.PublishingSchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PRN232v1.Models.Ranking", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PRN232v1.Models.Series", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PRN232v1.Models.Submission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PRN232v1.Models.ActivityLog", b =>
                {
                    b.HasOne("PRN232v1.Models.Profile", "User")
            ...
            modelBuilder.Entity("PRN232v1.Models.AiSegmentationResult", b =>
                {
                    b.HasOne("PRN232v1.Models.Page", "Page")
            ...
            modelBuilder.Entity("PRN232v1.Models.Annotation", b =>
                {
                    b.HasOne("PRN232v1.Models.Profile", "CreatedByNavigation")
            ...
            modelBuilder.Entity("PRN232v1.Models.BoardVote", b =>
                {
                    b.HasOne("PRN232v1.Models.Profile", "BoardMember")
                        .WithMany("BoardVotes")
                        .HasForeignKey("BoardMemberId")
                        .HasConstraintName("board_votes_board_member_id_fkey");

                    b.HasOne("PRN232v1.Models.Series", "Series")
                        .WithMany("BoardVotes")
            ...
            modelBuilder.Entity("PRN232v1.Models.EditorTask", b =>
                {
                    b.HasOne("PRN232v1.Models.Profile", "AssignedByNavigation")
                        .WithMany("TaskAssignedByNavigations")
                        .HasForeignKey("AssignedBy")
                        .HasConstraintName("tasks_assigned_by_fkey");

                    b.HasOne("PRN232v1.Models.Profile", "AssignedToNavigation")
            ...
            modelBuilder.Entity("PRN232v1.Models.Page", b =>
                {
                    b.HasOne("PRN232v1.Models.Chapter", "Chapter")
                        .WithMany("Pages")
            ...
            modelBuilder.Entity("PRN232v1.Models.Series", b =>
                {
                    b.HasOne("PRN232v1.Models.Profile", "Author")
                        .WithMany("SeriesAuthors")
                        .HasForeignKey("AuthorId")
                        .IsRequired()
                        .HasConstraintName("series_author_id_fkey");

                    b.HasOne("PRN232v1.Models.Profile", "Editor")
