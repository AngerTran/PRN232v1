...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.Chapter", b =>
                {
                    ...
                    b.Property<Guid?>("ReviewAcceptedBy")
                        .HasColumnType("uuid")
                        .HasColumnName("review_accepted_by");
            ...
            modelBuilder.Entity("DAL.Models.Profile", b =>
                {
                    ...
                    b.Property<string>("PayoutBankAccountHolder")
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)")
            ...
            modelBuilder.Entity("DAL.Models.Series", b =>
                {
                    ...
                    b.Property<string>("EditorDefenseNote")
                        .HasColumnType("text")
                        .HasColumnName("editor_defense_note");

                    b.Property<DateTime?>("EditorDefenseNoteUpdatedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("editor_defense_note_updated_at");
            ...
            modelBuilder.Entity("DAL.Models.SeriesTaskPrice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("series_task_prices_pkey");

                    b.HasIndex("ApprovedBy");

                    b.HasIndex(new[] { "SeriesId", "TaskType" }, "uq_series_task_price_type")
                        .IsUnique();

                    b.ToTable("series_task_prices", (string)null);
                });

            modelBuilder.Entity("DAL.Models.SeriesTaskPriceProposal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("series_task_price_proposals_pkey");

                    b.HasIndex("ProposedBy");

                    b.HasIndex("ReviewedBy");

                    b.HasIndex(new[] { "SeriesId", "Status" }, "idx_series_task_price_proposals_series_status");

                    b.ToTable("series_task_price_proposals", (string)null);
                });

            modelBuilder.Entity("DAL.Models.SeriesTaskPriceProposalItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("series_task_price_proposal_items_pkey");

                    b.HasIndex(new[] { "ProposalId", "TaskType" }, "uq_series_task_price_proposal_item_type")
                        .IsUnique();

                    b.ToTable("series_task_price_proposal_items", (string)null);
                });
            ...
            modelBuilder.Entity("DAL.Models.TaskPriceTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("task_price_templates_pkey");

                    b.HasIndex(new[] { "TaskType" }, "uq_task_price_templates_type")
                        .IsUnique();

                    b.ToTable("task_price_templates", (string)null);
                });
            ...
            modelBuilder.Entity("DAL.Models.Chapter", b =>
                {
                    b.HasOne("DAL.Models.Profile", null)
                        .WithMany()
                        .HasForeignKey("ReviewAcceptedBy")
            ...
            modelBuilder.Entity("DAL.Models.SeriesTaskPrice", b =>
                {
                    b.HasOne("DAL.Models.Profile", "ApprovedByNavigation")
                        .WithMany("SeriesTaskPricesApproved")
                        .HasForeignKey("ApprovedBy")
                        .HasConstraintName("series_task_prices_approved_by_fkey");

                    b.HasOne("DAL.Models.Series", "Series")
                        .WithMany("SeriesTaskPrices")
                        .HasForeignKey("SeriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("DAL.Models.SeriesTaskPriceProposal", b =>
                {
                    b.HasOne("DAL.Models.Profile", "ProposedByNavigation")
                        .WithMany("SeriesTaskPriceProposalsCreated")
                    ...
                    b.HasOne("DAL.Models.Profile", "ReviewedByNavigation")
                        .WithMany("SeriesTaskPriceProposalsReviewed")
                        .HasForeignKey("ReviewedBy")
                        .HasConstraintName("series_task_price_proposals_reviewed_by_fkey");

                    b.HasOne("DAL.Models.Series", "Series")
                        .WithMany("TaskPriceProposals")
                        .HasForeignKey("SeriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("DAL.Models.SeriesTaskPriceProposalItem", b =>
                {
                    b.HasOne("DAL.Models.SeriesTaskPriceProposal", "Proposal")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("DAL.Models.Profile", b =>
                {
                    ...
                    b.Navigation("SeriesTaskPriceProposalsCreated");

                    b.Navigation("SeriesTaskPriceProposalsReviewed");

                    b.Navigation("SeriesTaskPricesApproved");
            ...
            modelBuilder.Entity("DAL.Models.Series", b =>
                {
                    ...
                    b.Navigation("SeriesTaskPrices");

                    b.Navigation("TaskPriceProposals");
                });
